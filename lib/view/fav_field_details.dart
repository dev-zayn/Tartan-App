...
class FavFieldDetails extends StatefulWidget {
  const FavFieldDetails({Key? key, required this.field}) : super(key: key);
  final FavFields field;

  @override
  State<FavFieldDetails> createState() => _FavFieldDetailsState();
}

class _FavFieldDetailsState extends State<FavFieldDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    fieldController.getFieldImages(widget.field.yard.id);
    fieldController.getFavField(widget.field.yard.id);
    GetStorage().write(widget.field.yard.id, false);
              ...
              child: ListView(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Textsax(
                                text: widget.field.yard.name,
                                fontSize: 24,
                                fontWeight: FontWeight.bold),
                            InkWell(
                              onTap: () {
                                fieldController
                                    .setFieldFav(widget.field.yard.id);
                              },
                              child: Container(
                        ...
                        Row(
                          children: [
                            Textsax(
                              text:
                                  '${widget.field.yard.address.neighborhood} - ',
                              fontSize: 15,
                              color: Colurs.grey,
                            ),
                            Textsax(
                              text: widget.field.yard.address.nearestPoint,
                              fontSize: 15,
                              color: Colurs.grey,
                            ),
                          ],
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: Textsax(
                                        ...
                                        // '${widget.field.yard.worktime.closeTime} - ${widget.field.yard.worktime.openTime}',
                                        color: Colurs.black,
                                        fontSize: 14))
                              ],
                            ),
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    Textsax(
                                        text:
                                            '${widget.field.yard.bookingPrice} ',
                                        color: Colurs.black,
                                        fontSize: 14),
                                    Textsax(
                                        text: 'د.ع',
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_context, index) {
                        return ServicesCard(
                          field: widget.field.yard.services.services[index],
                        );
                      },
                      itemCount: widget.field.yard.services.services.length,
                    ),
                  ),
                  Container(
                    padding: const EdgeInsets.symmetric(vertical: 10),
                  ...
                  Container(
                    ...
                    child: Textsax(
                        text: widget.field.yard.description,
                        fontSize: 13,
                        height: 1.4,
                        textDirection: ui.TextDirection.rtl,
                    ...
                    child: MaterialButton(
                      onPressed: () {
                        bookingController.setBooking(
                            widget.field.yard.id, _selectedValue.toString());
                      },
                      color: Colurs.green,
                      elevation: 0,
                      shape: RoundedRectangleBorder(
